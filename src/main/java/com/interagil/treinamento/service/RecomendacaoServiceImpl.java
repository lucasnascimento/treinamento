...
@Component("recomendacaoService")
@Transactional
class RecomendacaoServiceImpl implements RecomendacaoService {
	...
	public Recomendacao salvar(Recomendacao recomendacao) {
		if (!this.recomendacaoValidator.validar(recomendacao)){
			throw new IllegalArgumentException("Recomendacao informado invalida.");
		}
